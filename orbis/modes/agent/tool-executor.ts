//this file is the bridge btw ai tools and file sysytem
...
export class ToolExecutor {
  ...
  //excluded acts here as a security by ignoring certain files/folders
  ...
  //checks id ==f the file isnt excluded
  //rel: file path, op: operations
  ...
  //checks in in-memory stages(overlay, deleted) if there data exists in path 
  //gives priority to new data in overlay
  ...
  readFile(rel: string): string {
    ...
    //logs data from file read by it into tracker
  ...
  //executes shell cmds of allowed
  ...
  //ai reads these skills
  //skills needs to be present in directory
  skillRoots(): string[] {
    const extra =
  ...
  //after checking approval, it creates files/folder/mutations
